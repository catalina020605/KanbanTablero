...
const colorOptions = ["#ffffff", "#ff0000", "#00ff00", "#0000ff"]; // Colores disponibles
...
taskForm.addEventListener('submit', function (e) {
    ...
    colorButton.addEventListener('click', () => {
        ...
        colorSelect.className = 'color-list';
        for (const color of colorOptions) {
            const colorItem = document.createElement('li');
            colorItem.className = 'color-list-item';
        ...
        colorButton.parentElement.appendChild(colorSelect);
    });
    ...
    taskContent.appendChild(colorButton);
